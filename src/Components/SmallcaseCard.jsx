            ...
            <div className="flex items-center">
              <div className="flex gap-4 items-center">
                <div className="flex flex-col">
                  ...
                  <p className="text-[16px] text-[rgb(47,54,63)] font-bold">₹ {smallcase.stats.minInvestAmount}</p>
                </div>
                <div className="flex flex-col">
                  <p className="text-[rgb(129,135,140)] text-[14px] mb-2">{smallcase.stats.ratios.cagrDuration} CAGR</p>
                  <p>blurred</p>
                </div>
              </div>
              <div className="flex items-center px-2 py-1 ml-6 border border-[rgb(221,224,228)] rounded-md">
                <img alt="" src={riskLabel==='Low'?low : riskLabel==='Medium' ? medium : high} width="20px" height="20px" className="mr-1" ></img>
                <p className="text-s text-[rgb(83,91,98)] ">{smallcase.stats.ratios.riskLabel}</p>
              </div>
            </div>
          </section>
        </div>
